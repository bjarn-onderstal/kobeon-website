...
export const projects: Project[] = [
  ...
  },
  {
    ...
    accent: "yellow",
    transformation: "Van losse urenregistratie en handmatige onboarding naar EPSA Connect: één portaal én app voor opdrachten, uren en verificatie.",
    kind: "portal",
    ...
    video: {
      ...
      webm: "/visuals/case-epsa.webm",
      poster: "/visuals/case-epsa-poster.jpg",
    },
  },
  {
    slug: "golfclub",
