...
const accentStyles: Record<Sector["accent"], { border: string; tint: string; cta: string; chip: string }> = {
  teal: { border: "hover:border-teal", tint: "group-hover:bg-tealbg", cta: "text-teal", chip: "bg-tealbg text-teal" },
  purple: { border: "hover:border-purple", tint: "group-hover:bg-purplebg", cta: "text-purple", chip: "bg-purplebg text-purple" },
  yellow: { border: "hover:border-yellow", tint: "group-hover:bg-yellow/10", cta: "text-ink", chip: "bg-yellow/15 text-ink" },
};
